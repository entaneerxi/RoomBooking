        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostponeRequestedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NewCheckInDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NewCheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousWaterReading = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CurrentWaterReading = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PreviousElectricityReading = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CurrentElectricityReading = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyRentals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlyRentals_Bookings_BookingId",
            ...
            migrationBuilder.InsertData(
                table: "ContactInfos",
                columns: new[] { "Id", "Address", "CreatedAt", "Description", "Email", "MapEmbedUrl", "Phone", "PropertyName", "UpdatedAt", "Website" },
                values: new object[] { 1, "123 Main Street, City, Country", new DateTime(2025, 11, 16, 1, 0, 43, 383, DateTimeKind.Utc).AddTicks(8516), "Welcome to our room booking system", "info@roombooking.com", null, "+1234567890", "Room Booking System", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyRentals_BookingId",
                table: "MonthlyRentals",
                column: "BookingId",
                unique: true);
